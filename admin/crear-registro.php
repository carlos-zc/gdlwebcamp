  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Crear Registro de Visitante Manual</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
                            ...
                            <li class="col-md-4">
                                <div class="tabla-precio text-center">
                                    ...
                                    <div class="orden">
                                        ...
                                        <input type="number" class="form-control" id="pase_dosdias" min="0" size="3" name="boletos[dos_dias][cantidad]" placeholder="0">
                                      ...
                                      <div class="col-md-4">
                                          ...
                                          <?php foreach($evento_dia as $evento)  { ?>
                                            <div class="icheck-primary d-inline">
                                              <input type="checkbox" name="registro_evento[]" id="<?= $evento['id'] ?>" value="<?= $evento['clave'] ?>">
                                              <label for="<?= $evento['id'] ?>">
