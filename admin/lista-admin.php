                  ...
                  <?php 
                    ...
                    while($admin = $resultado->fetch_assoc()) { ?>
                      <tr>
                        ...
                        <td><?= $admin['nombre']?></td>
                        <td>
                          <a href="editar-admin.php?id=<?= $admin['id_admin'] ?>" class="btn bg-orange btn-flat mr-3">
                            <i class="fas fa-edit text-white"></i>
                          </a>

                          <a href="#" data-id="<?= $admin['id_admin']?>" data-tipo="admin" class="btn bg-maroon btn-flat margin borrar-registro">
